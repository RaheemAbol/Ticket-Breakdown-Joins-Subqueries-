-- *************************************************************
-- DATABASE SETUP: REAL ESTATE DATABASE (TB_12)
-- *************************************************************
-- Run this script before completing the ticket breakdown.
...
INSERT INTO Properties
    (Address, City, State, ZipCode, ListingPrice, ListingDate, TypeID, AgentID)
VALUES
...
INSERT INTO PropertyDetails
    (PropertyID, Bedrooms, Bathrooms, SquareFeet, YearBuilt, ParkingSpaces)
VALUES
(1, 3, 2.5, 2000, 1990, 2),
(2, 2, 1.5, 1500, 1985, 1),
(3, 4, 3.0, 2500, 2005, 2),
...
INSERT INTO Transactions
    (PropertyID, ClientID, AgentID, SalePrice, SaleDate, StatusID)
VALUES
...
-- Optional verification: each query should return the number of rows shown.
SELECT 'Agents' AS TableName, COUNT(*) AS RowCount FROM Agents
UNION ALL
SELECT 'Clients', COUNT(*) FROM Clients
UNION ALL
SELECT 'Properties', COUNT(*) FROM Properties
UNION ALL
SELECT 'PropertyDetails', COUNT(*) FROM PropertyDetails
UNION ALL
